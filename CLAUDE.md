...
**Add a Spotlight Card Type:** `HeroSpotlightBlock` is a 14-card rotating carousel; adding another touches 5 anchors (BE resolver + Data type + DI, FE SFC + dispatch/i18n/types) (~50 lines). Full 5-step recipe + verify commands + design/quality contract: **[`docs/spotlight-card-guidelines.md`](docs/spotlight-card-guidelines.md)**.
