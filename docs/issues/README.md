...
- **Root cause (two layers):**
  1. **External trigger:** `animepahe.pw` upstream is down — the `animepahe-resolver` stealth sidecar gets **502/503 on every `/search`** (4–7s each). Not our code; intermittent.
