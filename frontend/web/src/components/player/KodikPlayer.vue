<template>
  <div class="kodik-player">
    ...
    <EmptyState v-else-if="translations.length === 0 && !loadingTranslations" size="lg">
      <template #icon>
        <Film class="size-12 opacity-50" :stroke-width="1.5" aria-hidden="true" />
      </template>
        ...
        <div class="relative aspect-video bg-black rounded-xl overflow-hidden">
          ...
          >
            <div class="text-center text-white/40">
              <Play class="size-16 mx-auto mb-3" fill="currentColor" :stroke-width="0" aria-hidden="true" />
            ...
            >
              ...
              >
                <div class="flex items-center justify-between gap-2">
                  ...
                  >
                    <Check class="size-4 text-black" :stroke-width="3" aria-hidden="true" />
                  </div>
                </div>
              </button>
              ...
              >
                <Pin class="size-4" :fill="t.pinned ? 'currentColor' : 'none'" aria-hidden="true" />
              </button>
            </div>
          </template>
...
import { Star, Pin, Film, Play, List, Check, Mic, Captions } from 'lucide-vue-next'
