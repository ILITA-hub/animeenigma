...
onMounted(() => {
  ...
  document.addEventListener('pointerdown', keyboard.onDocumentPointerDown, true)
  document.addEventListener('focusin', keyboard.onDocumentFocusIn)
...
onUnmounted(() => {
  ...
  document.removeEventListener('pointerdown', keyboard.onDocumentPointerDown, true)
  document.removeEventListener('focusin', keyboard.onDocumentFocusIn)
