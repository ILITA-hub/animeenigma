    ...
    >
      ...
      <div class="w-16 h-22 flex-shrink-0 rounded-lg overflow-hidden bg-white/5">
        ...
        <div v-else class="w-full h-full flex items-center justify-center text-white/20">
          <Play class="size-8" fill="currentColor" aria-hidden="true" />
        </div>
      </div>
        ...
        <div class="flex items-start justify-between gap-2">
          <div class="min-w-0">
            ...
            >
              ...
              <ExternalLink class="size-3.5 flex-shrink-0 opacity-60" aria-hidden="true" />
            </router-link>
      ...
      <div class="flex items-center">
        <ChevronDown
          class="size-5 text-white/60 transition-transform duration-200"
