  ...
  <div class="relative" ref="containerRef">
    ...
    <Transition name="dropdown">
      <div
        ...
        :id="listboxId"
        role="listbox"
        class="absolute top-full left-0 right-0 mt-2 rounded-xl overflow-hidden z-50 max-h-96 overflow-y-auto bg-background/95 backdrop-blur-xl border border-white/10 shadow-2xl"
      >
        <router-link
