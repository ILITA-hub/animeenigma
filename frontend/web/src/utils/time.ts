...
/**
 * Local-day boundaries for a YYYY-MM-DD <input type="date"> value, as RFC3339
 * instants — so a server-side "submitted on day X" filter means the USER's
 * calendar day. Empty/invalid input → undefined (no bound).
 */
