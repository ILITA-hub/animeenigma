...
replace github.com/ILITA-hub/animeenigma/libs/metrics => ../metrics

replace github.com/ILITA-hub/animeenigma/libs/tracing => ../tracing

replace github.com/ILITA-hub/animeenigma/libs/authz => ../authz
